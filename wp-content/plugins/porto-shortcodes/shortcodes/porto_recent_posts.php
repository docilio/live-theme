...
function porto_load_recent_posts_shortcode() {
    ...
    vc_map( array(
        'name' => "Porto " . __('Recent Posts', 'porto'),
        ...
        "params" => array(
            ...
            array(
                'type' => 'checkbox',
                'heading' => __( 'Show Post Image', 'porto' ),
            ...
            array(
                "type" => "textfield",
                "heading" => __("Items to show on Desktop", "porto"),
                "param_name" => "items_desktop",
                "value" => "4"
            ),
            array(
                "type" => "textfield",
                "heading" => __("Items to show on Tablets", "porto"),
                "param_name" => "items_tablets",
                "value" => "3"
            ),
            array(
                "type" => "textfield",
                "heading" => __("Items to show on Mobile", "porto"),
