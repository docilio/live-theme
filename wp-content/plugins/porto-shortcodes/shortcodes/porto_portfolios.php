...
function porto_load_portfolios_shortcode() {
    ...
    vc_map( array(
        'name' => "Porto " . __('Portfolios', 'porto'),
        ...
        "params" => array(
            ...
            array(
                "type" => "dropdown",
                "heading" => __("Portfolio Layout", "porto"),
            ...
            array(
                "type" => "textfield",
                "heading" => __("Portfolio IDs", "porto"),
                "description" => __("comma separated list of portfolio ids", "porto"),
                "param_name" => "post_in"
            ),
            array(
                "type" => "textfield",
                "heading" => __("Portfolios Count", "porto"),
                "param_name" => "number",
                "value" => '8'
            ),
            array(
