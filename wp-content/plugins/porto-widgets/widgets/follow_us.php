...
class Porto_Follow_Us_Widget extends WP_Widget {
    ...
    function Porto_Follow_Us_Widget() {
        ...
        $widget_ops = array('classname' => 'follow-us', 'description' => __('Add Social Links.', 'porto'));

        $control_ops = array('id_base' => 'follow-us-widget');

        $this->WP_Widget('follow-us-widget', __('Porto: Follow Us', 'porto'), $widget_ops, $control_ops);
    }
    ...
    function widget($args, $instance) {
        ...
        <div class="share-links">
            ...
            <?php
            if ($facebook) :
                ?><a href="<?php echo esc_url($facebook) ?>" target="_blank" data-toggle="tooltip" data-placement="bottom" title="<?php echo __('Facebook', 'porto') ?>" class="share-facebook"><?php echo __('Facebook', 'porto') ?></a><?php
            endif;

            if ($twitter) :
                ?><a href="<?php echo esc_url($twitter) ?>" target="_blank" data-toggle="tooltip" data-placement="bottom" title="<?php echo __('Twitter', 'porto') ?>" class="share-twitter"><?php echo __('Twitter', 'porto') ?></a><?php
            endif;

            if ($rss) :
                ?><a href="<?php echo esc_url($rss) ?>" target="_blank" data-toggle="tooltip" data-placement="bottom" title="<?php echo __('RSS', 'porto') ?>" class="share-rss"><?php echo __('RSS', 'porto') ?></a><?php
            endif;

            if ($pinterest) :
                ?><a href="<?php echo esc_url($pinterest) ?>" target="_blank" data-toggle="tooltip" data-placement="bottom" title="<?php echo __('Pinterest', 'porto') ?>" class="share-pinterest"><?php echo __('Pinterest', 'porto') ?></a><?php
            endif;

            if ($youtube) :
                ?><a href="<?php echo esc_url($youtube) ?>" target="_blank" data-toggle="tooltip" data-placement="bottom" title="<?php echo __('Youtube', 'porto') ?>" class="share-youtube"><?php echo __('Youtube', 'porto') ?></a><?php
            endif;

            if ($instagram) :
                ?><a href="<?php echo esc_url($instagram) ?>" target="_blank" data-toggle="tooltip" data-placement="bottom" title="<?php echo __('Instagram', 'porto') ?>" class="share-instagram"><?php echo __('Instagram', 'porto') ?></a><?php
            endif;

            if ($skype) :
                ?><a href="<?php echo esc_url($skype) ?>" target="_blank" data-toggle="tooltip" data-placement="bottom" title="<?php echo __('Skype', 'porto') ?>" class="share-skype"><?php echo __('Skype', 'porto') ?></a><?php
            endif;

            if ($linkedin) :
                ?><a href="<?php echo esc_url($linkedin) ?>" target="_blank" data-toggle="tooltip" data-placement="bottom" title="<?php echo __('Linkedin', 'porto') ?>" class="share-linkedin"><?php echo __('Linkedin', 'porto') ?></a><?php
            endif;

            if ($googleplus) :
                ?><a href="<?php echo esc_url($googleplus) ?>" target="_blank" data-toggle="tooltip" data-placement="bottom" title="<?php echo __('Google +', 'porto') ?>" class="share-googleplus"><?php echo __('Google +', 'porto') ?></a><?php
            endif;
            ?>
    ...
    function form($instance) {
        $defaults = array('title' => __('Follow Us', 'porto'), 'follow_before' => '', 'facebook' => '', 'twitter' => '', 'rss' => '', 'pinterest' => '', 'youtube' => '', 'instagram' => '', 'skype' => '', 'linkedin' => '', 'googleplus' => '', 'follow_after' => '');
        $instance = wp_parse_args((array) $instance, $defaults); ?>

        <p>
            <label for="<?php echo $this->get_field_id('title'); ?>">
                <strong><?php echo __('Title', 'porto') ?>:</strong>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('follow_before'); ?>">
                <strong><?php echo __('Before Description', 'porto') ?>:</strong>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('facebook'); ?>">
                <strong><?php echo __('Facebook', 'porto') ?>:</strong>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('twitter'); ?>">
                <strong><?php echo __('Twitter', 'porto') ?>:</strong>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('rss'); ?>">
                <strong><?php echo __('RSS', 'porto') ?>:</strong>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('pinterest'); ?>">
                <strong><?php echo __('Pinterest', 'porto') ?>:</strong>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('youtube'); ?>">
                <strong><?php echo __('Youtube', 'porto') ?>:</strong>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('instagram'); ?>">
                <strong><?php echo __('Instagram', 'porto') ?>:</strong>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('skype'); ?>">
                <strong><?php echo __('Skype', 'porto') ?>:</strong>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('linkedin'); ?>">
                <strong><?php echo __('Linkedin', 'porto') ?>:</strong>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('googleplus'); ?>">
                <strong><?php echo __('Google +', 'porto') ?>:</strong>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('follow_after'); ?>">
                <strong><?php echo __('After Description', 'porto') ?>:</strong>
