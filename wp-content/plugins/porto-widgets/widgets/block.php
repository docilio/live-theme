...
class Porto_Block_Widget extends WP_Widget {
    ...
    function Porto_Block_Widget() {
        ...
        $widget_ops = array('classname' => 'widget-block', 'description' => __('Show block.', 'porto'));

		$control_ops = array('id_base' => 'block-widget');

		$this->WP_Widget('block-widget', __('Porto: Block', 'porto'), $widget_ops, $control_ops);
	}
	...
	function form($instance) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('name'); ?>">
                <strong><?php _e('Block Slug Name', 'porto') ?>:</strong>
