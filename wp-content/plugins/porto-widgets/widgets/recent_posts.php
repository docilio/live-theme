...
class Porto_Recent_Posts_Widget extends WP_Widget {
    ...
    {
        $widget_ops = array('classname' => 'widget-recent-posts', 'description' => __('Show recent posts.', 'porto'));

        $control_ops = array('id_base' => 'recent_posts-widget');

        $this->WP_Widget('recent_posts-widget', __('Porto: Recent Posts', 'porto'), $widget_ops, $control_ops);
    }
    ...
    {
        $defaults = array('title' => __('Recent Posts', 'porto'), 'number' => 6, 'items' => 3, 'view' => 'small', 'cat' => '', 'show_image' => 'on');
        ...
        <p>
            <label for="<?php echo $this->get_field_id('number'); ?>">
                <strong><?php _e('Number of posts to show', 'porto') ?>:</strong>
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id('show_image'); ?>"><?php echo __('Show Post Image', 'porto') ?></label>
        </p>
    <?php
    }
}
