...
<div class="cart_totals <?php if ( WC()->customer->has_calculated_shipping() ) echo 'calculated_shipping'; ?>">
    ...
    <table class="shop_table <?php if ($porto_woo_version >= 2.3) : ?> responsive <?php endif; ?>cart-total" cellspacing="0">
        ...
        <?php elseif ( WC()->cart->needs_shipping() && $porto_woo_version >= '2.3.6' ) : ?>
