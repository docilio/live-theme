...
<nav class="woocommerce-pagination">
	...
	<?php
        ...
        echo paginate_links( apply_filters( 'woocommerce_pagination_args', array(
			'base'         => $porto_woo_version < 2.3 ? esc_url( str_replace( 999999999, '%#%', remove_query_arg( 'add-to-cart', get_pagenum_link( 999999999, false ) ) ) ) : esc_url_raw( str_replace( 999999999, '%#%', remove_query_arg( 'add-to-cart', get_pagenum_link( 999999999, false ) ) ) ),
			'format'       => '',
            'add_args'     => '',
