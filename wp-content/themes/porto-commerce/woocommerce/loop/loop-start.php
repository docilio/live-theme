...
if (is_archive()) {
    if (!is_shop()) {
        ...
        $cols = $porto_settings['shop-product-cols'];
    }
}
...
?>
<ul class="products <?php if (isset($woocommerce_loop['widget']) && $woocommerce_loop['widget']) echo 'product_list_widget' ?> <?php echo isset($woocommerce_loop['view'])?$woocommerce_loop['view']:'' ?> pcols-lg-<?php echo $cols ?> pcols-md-<?php echo $cols_md ?> pcols-xs-<?php echo $cols_xs ?> pcols-ls-<?php echo $cols_ls ?>  pwidth-lg-<?php echo $item_width ?> pwidth-md-<?php echo $item_width_md ?> pwidth-xs-<?php echo $item_width_xs ?> pwidth-ls-<?php echo $item_width_ls ?>"<?php if (isset($woocommerce_loop['view']) && $woocommerce_loop['view'] == 'products-slider') : ?> data-cols-lg="<?php echo $cols ?>" data-cols-md="<?php echo $cols_md ?>" data-cols-xs="<?php echo $cols_xs ?>" data-cols-ls="<?php echo $cols_ls ?>"<?php if (isset($woocommerce_loop['navigation']) && $woocommerce_loop['navigation']) echo ' data-navigation="1"' ?><?php if (isset($woocommerce_loop['pagination']) && $woocommerce_loop['pagination']) echo ' data-pagination="1"' ?><?php endif; ?>>