...
// edit menu walker
add_filter( 'wp_edit_nav_menu_walker', 'porto_edit_walker', 10, 2 );

function porto_edit_walker($walker,$menu_id) {
...
class Walker_Nav_Menu_Edit_Custom extends Walker_Nav_Menu  {
    ...
    <div class="edit-menu-item-block-<?php echo $item_id; ?>" style="<?php if ($depth == 1) echo 'display:block;'; else echo 'display:none;' ?>">
        ...
        <p class="description description-wide">
            <label for="edit-menu-item-subpopup_bg_image-<?php echo $item_id; ?>">
                <?php echo 'Background Image (only wide)'; ?><br />
                <input type="text" id="edit-menu-item-subpopup_bg_image-<?php echo $item_id; ?>" class="widefat code edit-menu-item-popup_bg_image"
                    <?php if (esc_attr( $item->popup_bg_image )) : ?>
                        name="menu-item-popup_bg_image[<?php echo $item_id; ?>]"
                    <?php endif; ?>
                       data-name="menu-item-popup_bg_image[<?php echo $item_id; ?>]"
                       value="<?php echo esc_attr( $item->popup_bg_image ); ?>" />
                <br/>
                <input class="button_upload_image button" id="edit-menu-item-subpopup_bg_image-<?php echo $item_id; ?>" type="button" value="Upload Image" />&nbsp;
                <input class="button_remove_image button" id="edit-menu-item-subpopup_bg_image-<?php echo $item_id; ?>" type="button" value="Remove Image" />
            </label>
        </p>
        <p class="description description-wide">
            <label for="edit-menu-item-subpopup_bg_pos-<?php echo $item_id; ?>">
                <br/><?php echo 'Background Position (only wide)'; ?><br />
                <select id="edit-menu-item-subpopup_bg_pos-<?php echo $item_id; ?>"
                    <?php if ($item->popup_bg_pos) : ?>
                        name="menu-item-popup_bg_pos[<?php echo $item_id; ?>]"
                    <?php endif; ?>
                        data-name="menu-item-popup_bg_pos[<?php echo $item_id; ?>]"
        ...
        <p class="description description-wide">
            <label for="edit-menu-item-subpopup_bg_repeat-<?php echo $item_id; ?>">
                <br/><?php echo 'Background Repeat (only wide)'; ?><br />
                <select id="edit-menu-item-subpopup_bg_repeat-<?php echo $item_id; ?>"
                    <?php if ($item->popup_bg_repeat) : ?>
                        name="menu-item-popup_bg_repeat[<?php echo $item_id; ?>]"
                    <?php endif; ?>
                        data-name="menu-item-popup_bg_repeat[<?php echo $item_id; ?>]"
        ...
        <p class="description description-wide">
            <label for="edit-menu-item-subpopup_bg_size-<?php echo $item_id; ?>">
                <br/><?php echo 'Background Size (only wide)'; ?><br />
                <select id="edit-menu-item-subpopup_bg_size-<?php echo $item_id; ?>"
                    <?php if ($item->popup_bg_size) : ?>
                        name="menu-item-popup_bg_size[<?php echo $item_id; ?>]"
                    <?php endif; ?>
                        data-name="menu-item-popup_bg_size[<?php echo $item_id; ?>]"
        ...
        <p class="description description-wide">
            <label for="edit-menu-item-subpopup_style-<?php echo $item_id; ?>">
                <?php echo 'Custom Styles (only wide)'; ?><br />
                <textarea id="edit-menu-item-subpopup_style-<?php echo $item_id; ?>" class="widefat edit-menu-item-popup_style" rows="3" cols="20"
                    <?php if (esc_html( $item->popup_style )) : ?>
                        name="menu-item-popup_style[<?php echo $item_id; ?>]"
                    <?php endif; ?>
                          data-name="menu-item-popup_style[<?php echo $item_id; ?>]"
