    ...
    if ( ! class_exists( 'ReduxDebugObject' ) ) {
        ...
        class ReduxDebugObject {
            ...
            public function render() {
                ...
                echo '<a href="#" id="consolePrintObject" class="button">' . 'Show Object in Javascript Console Object' . '</a>';
            ...
            public function render_tab() {
                ...
                echo '<a href="javascript:void(0);" id="dev_mode_default_section_group_li_a" class="redux-group-tab-link-a custom-tab" data-rel="dev_mode_default">' . $icon . ' <span class="group_title">' . 'Options Object' . '</span></a>';
                echo '</li>';
            }
