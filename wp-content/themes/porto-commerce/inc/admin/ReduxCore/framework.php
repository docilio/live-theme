    ...
    if ( ! class_exists( 'ReduxFramework' ) ) {
        ...
        class ReduxFramework {
            ...
            public function _admin_bar_menu() {
                ...
                if ( $menu ) {
                    ...
                    $nodeargs = array(
                        ...
                        'title' => $title,
                        // $theme_data->get( 'Name' ) . " " . 'Options', 'redux-framework-demo' ),
            ...
            public function _enqueue() {
                 ...
                 */
                $save_pending = apply_filters( "redux/{$this->args['opt_name']}/localize/save_pending", 'You have changes that are not saved. Would you like to save them now?' );
                 ...
                 */
                $reset_all = apply_filters( "redux/{$this->args['opt_name']}/localize/reset", 'Are you sure? Resetting will lose all custom values.' );
                 ...
                 */
                $reset_section = apply_filters( "redux/{$this->args['opt_name']}/localize/reset_section", 'Are you sure? Resetting will lose all custom values in this section.' );
                 ...
                 */
                $preset_confirm = apply_filters( "redux/{$this->args['opt_name']}/localize/preset", 'Your current options will be replaced with the values of this preset. Would you like to proceed?' );
                global $pagenow;
            ...
            public function _options_page_html() {
                ...
                if ( ! empty( $this->args['display_name'] ) ) {
                    ...
                    if ( isset( $this->args['dev_mode'] ) && $this->args['dev_mode'] ) {
                        echo '<span class="redux-dev-mode-notice">' . 'Developer Mode Enabled' . '</span>';
                    }
                ...
                echo '<a href="javascript:void(0);" class="expand_options' . $expanded . '">' . 'Expand' . '</a>';
                echo '<div class="redux-action_bar">';
                submit_button( 'Save Changes', 'primary', 'redux_save', false );

                if ( false === $this->args['hide_reset'] ) {
                    echo '&nbsp;';
                    submit_button( 'Reset Section', 'secondary', $this->args['opt_name'] . '[defaults-section]', false );
                    echo '&nbsp;';
                    submit_button( 'Reset All', 'secondary', $this->args['opt_name'] . '[defaults]', false );
                }
                ...
                if ( isset( $this->transients['last_save_mode'] ) ) {
                    ...
                    if ( $this->transients['last_save_mode'] == "import" ) {
                         ...
                         */
                        echo '<div class="admin-notice notice-blue saved_notice"><strong>' . apply_filters( "redux-imported-text-{$this->args['opt_name']}", 'Settings Imported!' ) . '</strong></div>';
                        //exit();
                         ...
                         * @param string  translated "settings imported" text
                         */
                        echo '<div class="saved_notice admin-notice notice-yellow"><strong>' . apply_filters( "redux-defaults-text-{$this->args['opt_name']}", 'All Defaults Restored!' ) . '</strong></div>';
                         ...
                         * @param string  translated "settings imported" text
                         */
                        echo '<div class="saved_notice admin-notice notice-yellow"><strong>' . apply_filters( "redux-defaults-section-text-{$this->args['opt_name']}", 'Section Defaults Restored!' ) . '</strong></div>';
                    } else {
                        /**
                         ...
                         */
                        echo '<div class="saved_notice admin-notice notice-green"><strong>' . apply_filters( "redux-saved-text-{$this->args['opt_name']}", 'Settings Saved!' ) . '</strong></div>';
                    }
                 ...
                 */
                echo '<div class="redux-save-warn notice-yellow"><strong>' . apply_filters( "redux-changed-text-{$this->args['opt_name']}", 'Settings have changed, you should save them!' ) . '</strong></div>';
                ...
                if ( $this->args['system_info'] === true ) {
                    ...
                    echo '<a href="javascript:void(0);" id="system_info_default_section_group_li_a" class="redux-group-tab-link-a custom-tab" data-rel="system_info_default">' . $icon . ' <span class="group_title">' . 'System Info' . '</span></a>';
                    echo '</li>';
                }
