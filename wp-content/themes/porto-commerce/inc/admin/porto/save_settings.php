...
function porto_compile_css() {

    if ( current_user_can( 'manage_options' ) && isset( $_GET['compile_theme'] ) ) {
    ...
    if ( current_user_can( 'manage_options' ) && isset( $_GET['compile_theme_rtl'] ) ) {
    ...
    if ( current_user_can( 'manage_options' ) && isset( $_GET['compile_plugins'] ) ) {
    ...
    if ( current_user_can( 'manage_options' ) && isset( $_GET['compile_plugins_rtl'] ) ) {
