    ...
    $.extend(theme, {
        ...
        MobileCheck: {
            ...
            any: function() {
                ...
                initialized = true;
                this.is_mobile = (this.Android() || this.BlackBerry() || this.iOS() || this.Opera() || this.Windows());
                return this.is_mobile;
            }
        }
            ...
            events: function() {
                ...
                self.$toggle.click(function() {
                    ...
                    if ($this.hasClass('closed')) {
                        ...
                        $widget.find('.sidebar-menu-wrap').stop().slideDown();
                    } else {
                        $this.addClass('closed');
                        $widget.addClass('closed');
                        $widget.find('.sidebar-menu-wrap').stop().slideUp();
                    }
                });
    ...
    $.extend(theme, {
        ...
        StickyHeader: {
            ...
            build: function() {
                ...
                if (self.$menu_wrap && !self.isTablet()) {
                    ...
                    if (self.$header.hasClass('sticky-menu-header') && !self.isTablet()) {
                        self.$header_main.css('top', 0);
                        self.$header.removeClass('sticky-header');
                        ...
                        if (self.$menu_wrap)
                            self.$menu_wrap.css('top', 0);
                        if (scroll_top > self.sticky_pos && (!self.isTablet() || (self.isTablet() && (!self.isMobile() && theme.show_sticky_header_tablet) || (self.isMobile() && theme.show_sticky_header_tablet && theme.show_sticky_header_mobile)))) {
                            self.$header.addClass('sticky-header');
                            self.$header.css('padding-bottom', self.sticky_header_height);
