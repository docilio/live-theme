...
if (!$gradient) {
    ...
    echo '<hr class="separator-line ' . $el_class . ($el_width?' separator-line-'.$el_width:'').'" style="'.
        (($color != 'rgba(0,0,0,0.2)' || ($align != 'align_center'))?'background-image: -webkit-linear-gradient(left'.(($align == 'align_center' || $align == 'align_right')?', transparent':'').', '.$color.(($align == 'align_center' || $align == 'align_left')?', transparent':'').'); background-image: linear-gradient(to right'.(($align == 'align_center' || $align == 'align_right')?', transparent':'').', '.$color.(($align == 'align_center' || $align == 'align_left')?', transparent':'').');':'').
